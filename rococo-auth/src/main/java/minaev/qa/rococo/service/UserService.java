...
import minaev.qa.rococo.data.Authority;
import minaev.qa.rococo.data.AuthorityEntity;
import minaev.qa.rococo.data.UserEntity;
import minaev.qa.rococo.data.repository.UserRepository;
import minaev.qa.rococo.model.UserJson;
